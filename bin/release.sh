#!/usr/bin/env bash
#
# release.sh — cut a tagged release of agent-chat-skill.
#
# Refuses to proceed when a precondition isn't met, so a release can't go out
# from a dirty tree, the wrong branch, or with the smoke test failing.
#
# Usage:
